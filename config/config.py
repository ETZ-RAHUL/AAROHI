...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ETZ-RAHUL/AAROHI")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ruh_se_ruh_tak")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+5UOuUqr37sNlZjNl")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/24a7a64e948832c5cddf1.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://telegra.ph/file/b075302a50a95b914603e.jpg",
)
